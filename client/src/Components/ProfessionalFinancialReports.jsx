      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <h3 className="text-sm font-medium text-gray-600 mb-1">Trial Balance</h3>
  ...
  const renderTrialBalance = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Trial Balance Summary</h3>
  ...
  const renderDailySales = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Sales by Shop and Payment Method</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
  ...
  const renderDailyExpenses = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Expenses by Shop and Category</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
  ...
  const renderMonthlySales = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Daily Breakdown */}
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Daily Breakdown for {monthlySalesData.period}</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
  ...
  const renderMonthlyExpenses = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Daily Breakdown */}
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Daily Breakdown for {monthlyExpensesData.period}</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
  ...
  const renderYearlySales = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Monthly Breakdown */}
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Monthly Breakdown for {yearlySalesData.year}</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
  ...
  const renderYearlyExpenses = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Monthly Breakdown */}
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
          <h3 className="text-lg font-semibold text-gray-900 mb-4">Monthly Breakdown for {yearlyExpensesData.year}</h3>
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
