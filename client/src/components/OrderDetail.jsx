          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Created {formatDate(orderData.created_at)}
              </p>
            </div>
          </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium capitalize">
                    {orderData.payment_method === 'split' ? 'Split Payment' : (orderData.payment_method || 'Not specified')}
                  </span>
                </div>

                {orderData.payment_method === 'split' && orderData.payment_details && (
                  <div className="mt-2 text-sm bg-gray-50 p-2 rounded">
                    <p className="font-medium mb-1 text-xs text-gray-500 uppercase">Payment Breakdown</p>
                    {(() => {
                      let details = orderData.payment_details;
              ...
              {orderItems && orderItems.length > 0 ? (
                  ...
                  <div key={item.id || index} className="p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500">
                          ${parseFloat(item.unit_price || item.price || 0).toFixed(2)} {item.currency || 'RWF'} × {item.quantity || 0}
                        </p>
                      </div>

                      <div className="text-right">
                        <p className="font-medium text-gray-900">
                          ${parseFloat(item.total_price || item.total || 0).toFixed(2)} {item.currency || 'RWF'}
                        </p>
                ...
                <div className="p-8 text-center text-gray-500">
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    {loading ? 'Loading items...' : 'This order has no items or items could not be loaded'}
                  </p>
                </div>
              )}
            </div>
