  ...
  const features = [
    {
      ...
      description: 'Manage multiple retail locations with centralized control'
    },
    {
      icon: Award,
      title: 'Loyalty Program',
      description: 'Customer loyalty tiers and points management system'
    },
    {
      icon: CreditCard,
      title: 'Layaway System',
      description: 'Advanced payment and installment tracking'
    }
  ];
        ...
        <div className="relative z-10 max-w-lg mx-auto px-8 text-center text-white">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-gray-300 leading-relaxed">
              Comprehensive retail management platform with inventory control, sales tracking, customer loyalty,
          ...
          <div className="mt-12 grid grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-white/5 rounded-xl border border-white/10">
              ...
              <div className="text-sm text-gray-300">Retail Locations</div>
            </div>
            <div className="text-center p-4 bg-white/5 rounded-xl border border-white/10">
