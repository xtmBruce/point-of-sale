    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage sales transactions and order history</p>
            ...
            <div className="flex items-start">
              ...
              <div className="ml-3">
                <p className="text-sm text-green-700">
                  <strong>Pro Tip:</strong> Click "New Order" to create sales, or click on any order to view details and make changes.
                </p>
              </div>
            </div>
          </div>
