    ...
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-header">
          <h3 className="text-heading-3">Recent Integrations</h3>
        </div>
...
const IntegrationsTab = ({ 
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="card">
        <div className="card-header">
          <h3 className="text-heading-3">Integrations ({integrations.length})</h3>
        </div>
        <div className="divide-y divide-gray-200">
...
const ExecutionsTab = () => {
  return (
    <div className="card">
      <div className="card-header">
        <h3 className="text-heading-3">Recent Executions</h3>
      </div>
...
const AnalyticsTab = ({ analytics, isLoading }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="card">
        <div className="card-header">
          <h3 className="text-heading-3">Integration Analytics</h3>
        </div>
        <div className="card-body">
