  ...
  const tabs = [
    {
      ...
      name: 'Overview',
      icon: BarChart3,
      description: 'Notification analytics and insights'
    },
    {
      id: 'templates',
      name: 'Templates',
    ...
    },
    {
      ...
      name: 'Triggers',
      icon: Settings,
      description: 'Automated notification triggers'
    }
  ];
    ...
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-3xl font-bold text-gray-900">Notifications & Engagement</h1>
            <p className="text-gray-600 mt-2">SMS, Email, and Push notification management</p>
          </div>
        </div>
        <div className="flex items-center space-x-3">
            {/* <button 
