...
const SmartBottling = () => {
  ...
  const { data: statsData, isLoading: statsLoading, error: statsError } = useQuery({
    ...
    queryFn: () => smartBottlingAPI.getStats(stats').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 30000,
  });
  ...
  const { data: rawMaterialsData, isLoading: materialsLoading, error: materialsError } = useQuery({
    ...
    queryFn: () => smartBottlingAPI.getStats(raw-materials').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 30000,
  });
  ...
  const { data: recipesData, isLoading: recipesLoading, error: recipesError } = useQuery({
    ...
    queryFn: () => smartBottlingAPI.getStats(recipes').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 30000,
  });
  ...
  const { data: batchesData, isLoading: batchesLoading, error: batchesError } = useQuery({
    ...
    queryFn: () => smartBottlingAPI.getStats(batches').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 30000,
  });
  ...
  const { data: forecastData, isLoading: forecastLoading, error: forecastError } = useQuery({
    ...
    queryFn: () => smartBottlingAPI.getStats(forecast').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 60000,
  });
  ...
  const { data: lowStockAlerts, isLoading: alertsLoading, error: alertsError } = useQuery({
    ...
    queryFn: () => smartBottlingAPI.getStats(low-stock-alerts').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 30000,
  });
  ...
  const { data: popularSizesData, isLoading: sizesLoading, error: sizesError } = useQuery({
    ...
    queryFn: () => smartBottlingAPI.getStats(popular-sizes').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 60000,
  });
  ...
  const { data: suppliersData, isLoading: suppliersLoading, error: suppliersError } = useQuery({
    queryKey: ['suppliers'],
    queryFn: () => procurementAPI.getSuppliers(suppliers').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
  ...
  const { data: supplierMaterialsData, isLoading: supplierMaterialsLoading, error: supplierMaterialsError } = useQuery({
    ...
    queryFn: () => procurementAPI.getSuppliers(supplier-materials').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 300000, // 5 minutes
  });
  ...
  const { data: purchaseOrdersData, isLoading: purchaseOrdersLoading, error: purchaseOrdersError } = useQuery({
    ...
    queryFn: () => procurementAPI.getSuppliers(purchase-orders').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 300000, // 5 minutes
  });
  ...
  const { data: bottleSizesData, isLoading: bottleSizesLoading, error: bottleSizesError } = useQuery({
    ...
    queryFn: () => perfumeAPI.getBottleSizes(bottle-sizes').then(res => res.data),
    retry: 3,
    retryDelay: 1000,
    staleTime: 300000, // 5 minutes
  });
  ...
  const { data: bulkPerfumesData, error: bulkPerfumesError, isLoading: bulkPerfumesLoading } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await perfumeAPI.getBottleSizes(bulk');
  ...
  const createRawMaterialMutation = useMutation({
    mutationFn: (data) => {
      return smartBottlingAPI.createRawMaterial(raw-materials', data);
    },
    onSuccess: () => {
  ...
  const createRecipeMutation = useMutation({
    mutationFn: (data) => smartBottlingAPI.createRawMaterial(recipes', data),
    onSuccess: () => {
  ...
  const createBatchMutation = useMutation({
    mutationFn: (data) => smartBottlingAPI.createRawMaterial(batch', data),
    onSuccess: () => {
  ...
  const createBottleSizeMutation = useMutation({
    mutationFn: (data) => perfumeAPI.createBulk(bottle-sizes', data),
    onSuccess: () => {
  ...
  const updateBottleSizeMutation = useMutation({
    mutationFn: ({ id, data }) => api.put(`/perfume/bottle-sizes/${id}`, data),
    onSuccess: () => {
      queryClient.invalidateQueries(['bottle-sizes']);
      queryClient.invalidateQueries(['bottling-stats']);
      setShowBottleSizeModal(false);
  ...
  const deleteBottleSizeMutation = useMutation({
    mutationFn: (id) => api.delete(`/perfume/bottle-sizes/${id}`),
    onSuccess: () => {
      queryClient.invalidateQueries(['bottle-sizes']);
      queryClient.invalidateQueries(['bottling-stats']);
  ...
  const handleBulkDelete = () => {
    ...
    if (activeTab === 'raw-materials') {
      selectedItems.forEach(id => {
        if (id) deleteRawMaterialMutation.mutate(id);
      });
    } else if (activeTab === 'recipes') {
      selectedItems.forEach(id => {
        if (id) deleteRecipeMutation.mutate(id);
      });
    } else if (activeTab === 'bottle-sizes') {
      selectedItems.forEach(id => {
        if (id) deleteBottleSizeMutation.mutate(id);
      });
    }
    clearSelection();
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Smart Bottling & Cost Tracking</h1>
      ...
      {showRawMaterialModal && (
        <RawMaterialModal 
          ...
          onSubmit={createRawMaterialMutation.mutate}
          isLoading={createRawMaterialMutation.isLoading}
      ...
      {showRecipeModal && (
        <RecipeModal 
          ...
          onSubmit={createRecipeMutation.mutate}
...
const DashboardTab = ({ stats, alerts, popularSizes, onCreateBatch, formatCurrency }) => {
  return (
    <div className="space-y-6">
      ...
      {/* Popular Sizes */}
      <div className="bg-white rounded-lg shadow p-6">
        <h3 className="text-lg font-medium text-gray-900 mb-4">Popular Bottle Sizes</h3>
        ...
        <div className="p-4">
          <div className="flex items-start justify-between mb-2">
            <h3 className={`text-lg font-semibold truncate flex-1 ${
              isNewGermanPerfume ? 'text-green-800' : 'text-gray-900'
            }`}>
              {material.name}
              {isNewGermanPerfume && (
                    ...
                    <div className="flex items-center">
                      <div className="flex-shrink-0">
                        <div className={`h-10 w-10 rounded-full flex items-center justify-center ${
                          isNewGermanPerfume ? 'bg-green-100' : 'bg-gray-100'
                        }`}>
                      ...
                      <div className="ml-4">
                        ...
                        <div className="text-sm text-gray-500">
                          {material.type} • {material.current_stock} {material.unit} • {formatCurrency(material.cost_per_unit)}/{material.unit}
                        </div>
                        <div className="text-sm text-gray-500">
        ...
        <div className="relative group">
          ...
          <div className="absolute top-2 left-2">
            <span className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${
              isGermanBatch ? 'bg-green-100 text-green-800' : 'bg-blue-100 text-blue-800'
            }`}>
              {batch.batch_number}
            </span>
          </div>
        ...
        <div className="p-4">
          ...
          <div className="space-y-2 mb-3">
            <div className="flex items-center justify-between">
              ...
              <span className="text-sm text-gray-900 font-medium">{batch.quantity_produced} units</span>
            </div>
            ...
            return (
              <div key={batch.id} className="bg-white rounded-lg border border-gray-200 p-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-4">
                    <div className="text-right">
                      <div className="text-sm font-medium text-gray-900">{batch.quantity_produced} units</div>
...
const ForecastTab = ({ forecast }) => {
  return (
    <div className="space-y-6">
      <h3 className="text-lg font-medium text-gray-900">Material Requirements Forecast</h3>
            ...
            <li key={item.material_id} className="px-6 py-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="text-sm text-gray-500">
                    Daily Average: {item.daily_average?.toFixed(2)} units
                  </div>
                </div>
                <div className="text-right">
...
// Modal Components
const RawMaterialModal = ({ onClose, onSubmit, isLoading, suppliers, supplierMaterials, purchaseOrders, suppliersLoading, supplierMaterialsLoading, purchaseOrdersLoading }) => {
    ...
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-10 mx-auto p-6 border w-4/5 max-w-4xl shadow-lg rounded-md bg-white">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-gray-900">Add Raw Material</h3>
          <button
            onClick={onClose}
...
const RecipeModal = ({ onClose, onSubmit, rawMaterials, isLoading, bottleSizes, bottleSizesLoading }) => {
  const [formData, setFormData] = useState({
    // Basic Information
    name: '',
    description: '',
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-10 mx-auto p-6 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-gray-900">Create Bottling Recipe</h3>
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-600"
          >
                      ...
                      <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500">
                            ...
                            {material.cost_per_unit && ` • Cost: $${material.cost_per_unit}/${material.unit}`}
                          </p>
                        </div>
                        <button
                          type="button"
...
const BatchModal = ({ onClose, onSubmit, recipes, isLoading, bulkPerfumesData, usersData, bulkPerfumesLoading, usersLoading, bulkPerfumesError, usersError }) => {
  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-10 mx-auto p-6 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
        <div className="flex justify-between items-center mb-6">
          <h3 className="text-xl font-semibold text-gray-900">Create Bottling Batch</h3>
          <button
            onClick={onClose}
            className="text-gray-400 hover:text-gray-600"
          >
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">Number of defective units (if known)</p>
                </div>
              </div>
        ...
        <div className="mt-3">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-gray-900">${batch.total_cost?.toFixed(2)}</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700">Unit Cost</label>
              <p className="mt-1 text-sm text-gray-900">${batch.unit_cost?.toFixed(2)}</p>
            </div>
    ...
    <div className="p-6">
      {sortedBottleSizes.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">No bottle sizes</h3>
          ...
          {sortedBottleSizes.map((bottleSize) => (
            <div
              ...
              className={`bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow ${
                selectedItems.has(bottleSize.id) ? 'ring-2 ring-blue-500' : ''
              }`}
            >
...
const BottleSizeModal = ({ onClose, onSubmit, bottleSize, isLoading }) => {
  const [formData, setFormData] = useState({
    ...
    labor_cost: bottleSize?.labor_cost || ''
  });
  ...
  const handleSubmit = (e) => {
    ...
    if (formData.labor_cost < 0) {
      newErrors.labor_cost = 'Labor cost must be 0 or greater';
    }
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.size_ml ? 'border-red-500' : 'border-gray-300'
                }`}
                placeholder="e.g., 50"
                required
              />
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.bottle_cost ? 'border-red-500' : 'border-gray-300'
                }`}
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.label_cost ? 'border-red-500' : 'border-gray-300'
                }`}
                placeholder="e.g., 500"
              />
              {errors.label_cost && (
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent ${
                  errors.packaging_cost ? 'border-red-500' : 'border-gray-300'
                }`}
